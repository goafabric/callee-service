...
import org.goafabric.personservice.VaultConfiguration;
...
public class StringEncryptor implements AttributeConverter<String, String> {
    ...
    public StringEncryptor(VaultConfiguration.MySecret mySecret) throws Exception {
        key = new SecretKeySpec(mySecret.myValue().getBytes(), "AES");
