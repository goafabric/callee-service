...
//
//    @PostConstruct
//    public void createInvoiceFile() throws IOException {
//        Files.write(new File("invoice.pdf").toPath(), createInvoice(createInvoiceData()));
//    }
//
//    private static InvoiceCreatorLogic.InvoiceData createInvoiceData() {
//        var organization = new InvoiceCreatorLogic.Organization("Practice Dr. Hibbert", Arrays.asList("Hibbertstreet 123", "443 Shelbyville"));
//        var patient = new InvoiceCreatorLogic.Patient("Homer", "Simpson", Arrays.asList("Mr", "Homer Simpson", "Evergreen Terrace 742", "443 Springfield"));
...
//        return new InvoiceCreatorLogic.InvoiceData(organization, patient, "E66.00 Adipositas",
