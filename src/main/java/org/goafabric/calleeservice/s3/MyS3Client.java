...
//	}
//
//	private record Bucket(@JacksonXmlProperty(localName = "Name") String name,
//						 @JacksonXmlProperty(localName = "CreationDate") OffsetDateTime creationDate) {
//	}
//
//	private record Content(@JacksonXmlProperty(localName = "Key") String key,
...
//	private record ListBucketResult(@JacksonXmlProperty(localName = "Name") String name,
