...
//    }
//
//    public void create(KubernetesClient client, List<DeploymentSpecification> deployments) {
...
//    }
//
//    public void update(KubernetesClient client, List<DeploymentSpecification> deployments) {
//        deployments.forEach(deploy -> {
