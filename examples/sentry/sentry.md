...
# tracing via collector and double fan out
  
- as an alternative we can use otel collector and double fanout, one to sentry on to standard otel like tempo and jaeger
