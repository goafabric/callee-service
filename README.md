...
# run jvm multi image
container image pull goafabric/callee-service:$(grep '^version=' gradle.properties | cut -d'=' -f2)
...
# run native image
container image pull goafabric/callee-service-native:$(grep '^version=' gradle.properties | cut -d'=' -f2)
