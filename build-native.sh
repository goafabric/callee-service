...
#docker pull goafabric/calle-service-native:1.0.2-SNAPSHOT && docker run --name spring-boot-example-graal-native --rm -p50900:50900 goafabric/calle-service-native:1.0.2-SNAPSHOT -Xmx64m
